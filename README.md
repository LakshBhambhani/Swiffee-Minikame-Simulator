...
Instructions:
Open the window and start coding with The Java API (no need to worry, you need to code in java and you definitely know this language): <a href = "https://lakshbhambhani.github.io/Swiffee-Minikame-Simulator/">Java API</a>
